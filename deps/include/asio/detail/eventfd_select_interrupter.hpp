...
public:
  ...
  // Get the async_read descriptor to be passed to select.
...
private:
  ...
  // The async_read end of a connection used to interrupt the select call. This file
  ...
  // differ from the async_read descriptor when a pipe is used.
