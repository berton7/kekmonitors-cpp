...
public:
  ...
  // Wait for the descriptor to become ready to async_read, ready to write, or to have
  ...
  // Read some data from the stream. Returns the number of bytes async_read.
  ...
  // Wait until data can be async_read without blocking.
  size_t read_some(implementation_type& impl,
      const null_buffers&, asio::error_code& ec)
  {
    // Wait for descriptor to become ready.
  ...
  // Start an asynchronous read. The buffer for the data being async_read must be
