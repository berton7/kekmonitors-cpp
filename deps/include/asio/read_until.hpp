...
/// delimiter.
/**
 * This function is used to async_read data into the specified dynamic buffer
 ...
 *
 * @param s The stream from which the data is to be async_read. The type must support
 * the SyncReadStream concept.
 *
 * @param buffers The dynamic buffer sequence into which the data will be async_read.
 *
 ...
 *
 * @par Example
 * To async_read data into a @c std::string until a newline is encountered:
 ...
 *
 * @par Example
 * To async_read data into a @c std::string until a CR-LF sequence is encountered:
 * @code std::string data;
 * std::size_t n = asio::read_until(s,
 *     asio::dynamic_buffer(data), "\r\n");
 * std::string line = data.substr(0, n);
 ...
 * the SyncReadStream concept.
 *
 * @param buffers A dynamic buffer sequence into which the data will be async_read.
 *
 * @param expr The regular expression.
 *
 * @param ec Set to indicate what error occurred, if any.
 ...
 *
 * @par Examples
 * To async_read data into a dynamic buffer sequence until whitespace is encountered:
 ...
 * @endcode
 *
 * To async_read data into a @c std::string until a matching character is found:
...
/**
 * This function is used to async_read data into the specified streambuf until the
 ...
 * the SyncReadStream concept.
 *
 * @param b A streambuf object into which the data will be async_read.
 *
 * @param delim The delimiter character.
 *
 ...
 *
 * @par Example
 * To async_read data into a streambuf until a newline is encountered:
...
/**
 * This function is used to async_read data into the specified streambuf until a
 ...
 *
 * @par Examples
 * To async_read data into a streambuf until whitespace is encountered:
 * @code typedef asio::buffers_iterator<
 ...
 * @endcode
 *
 * To async_read data into a streambuf until a matching character is found:
 * @code class match_char
 * {
 * public:
 *   explicit match_char(char c) : c_(c) {}
...
/// Start an asynchronous operation to async_read data into a dynamic buffer sequence
/// until it contains a specified delimiter.
/**
 * This function is used to asynchronously async_read data into the specified dynamic
 ...
 * the stream performs no other async_read operations (such as async_read,
 ...
 * @param delim The delimiter character.
 *
 * @param handler The handler to be called when the async_read operation completes.
 ...
 *
 * @par Example
 * To asynchronously async_read data into a @c std::string until a newline is
 * encountered:
 * @code std::string data;
 * ...
 ...
 *
 * @par Example
 * To asynchronously async_read data into a @c std::string until a CR-LF sequence is
 * encountered:
 * @code std::string data;
 * ...
 * void handler(const asio::error_code& e, std::size_t size)
 ...
 *
 * @par Examples
 * To asynchronously async_read data into a @c std::string until whitespace is
 * encountered:
 * @code typedef asio::buffers_iterator<
 *     asio::const_buffers_1> iterator;
 *
 ...
 * @endcode
 *
 * To asynchronously async_read data into a @c std::string until a matching character
 * is found:
 * @code class match_char
 * {
 * public:
...
/// Start an asynchronous operation to async_read data into a streambuf until it
/// contains a specified delimiter.
/**
 * This function is used to asynchronously async_read data into the specified
 ...
 * performs no other async_read operations (such as async_read, async_read_until, the
 ...
 * the AsyncReadStream concept.
 *
 * @param b A streambuf object into which the data will be async_read. Ownership of
 ...
 *
 * @par Example
 * To asynchronously async_read data into a streambuf until a newline is encountered:
 * @code asio::streambuf b;
 * ...
 * void handler(const asio::error_code& e, std::size_t size)
 * {
...
/// Start an asynchronous operation to async_read data into a streambuf until a
 ...
 *
 * @par Examples
 * To asynchronously async_read data into a streambuf until whitespace is encountered:
 * @code typedef asio::buffers_iterator<
 *     asio::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 ...
 * @endcode
 *
 * To asynchronously async_read data into a streambuf until a matching character is
 * found:
 * @code class match_char
 * {
 * public:
