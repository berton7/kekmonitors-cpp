...
public:
  ...
  /**
   * This function is used to close the serial port. Any asynchronous async_read or
  ...
  /**
   * This function causes all outstanding asynchronous async_read or write operations
  ...
  /**
   * This function is used to async_read data from the serial port. The function
  ...
  /**
   * This function is used to asynchronously async_read data from the serial port.
   * The function call always returns immediately.
   *
   * @param buffers One or more buffers into which the data will be async_read.
   * Although the buffers object may be copied as necessary, ownership of the
   ...
   * manner equivalent to using asio::post().
   *
   * @note The async_read operation may not read all of the requested number of bytes.
