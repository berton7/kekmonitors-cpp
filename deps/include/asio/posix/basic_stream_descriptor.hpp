...
public:
  ...
  /**
   * This function is used to async_read data from the stream descriptor. The function
  ...
  /**
   * This function is used to asynchronously async_read data from the stream
   * descriptor. The function call always returns immediately.
   *
   * @param buffers One or more buffers into which the data will be async_read.
   * Although the buffers object may be copied as necessary, ownership of the
