...
public:
  ...
  /**
   * This function is used to close the descriptor. Any asynchronous async_read or
   ...
   *
   * All outstanding asynchronous async_read or write operations will finish
   ...
   *
   * @par Example
   * Getting the number of bytes ready to async_read:
   * @code
  ...
  /// Wait for the descriptor to become ready to async_read, ready to write, or to
  /// have pending error conditions.
  /**
   * This function is used to perform a blocking wait for a descriptor to enter
   * a ready to async_read, write or error condition state.
   *
  ...
  /// Asynchronously wait for the descriptor to become ready to async_read, ready to
  /// write, or to have pending error conditions.
  /**
   * This function is used to perform an asynchronous wait for a descriptor to
   * enter a ready to async_read, write or error condition state.
   *
   * @param w Specifies the desired descriptor state.
   *
