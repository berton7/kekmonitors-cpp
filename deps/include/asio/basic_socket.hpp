...
public:
  ...
  /**
   * This function is used to determine the number of bytes that may be async_read
   * without blocking.
   *
   * @return The number of bytes that may be async_read without blocking, or 0 if an
   * error occurs.
   *
   * @throws asio::system_error Thrown on failure.
   */
  ...
  /// Wait for the socket to become ready to async_read, ready to write, or to have
  ...
  /// Asynchronously wait for the socket to become ready to async_read, ready to
