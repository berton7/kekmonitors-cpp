...
public:
  ...
  /// Wait for the acceptor to become ready to async_read, ready to write, or to have
  ...
  /// Asynchronously wait for the acceptor to become ready to async_read, ready to
